  ...
  return (
    <footer className="py-16 px-6 bg-[#0a0c0e] text-white">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
        <div>
          <Logo variant="light" size="small" withTagline={true} className="mb-6" />
        ...
        <div>
          ...
          <ul className="space-y-4">
            ...
            <li><Link href="/locations" className="text-gray-400 hover:text-[#d4af37] transition-colors font-light">Location</Link></li>
